    ...
    <div className="container mx-auto my-10">
      <div className="bg-[#f8fafe] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-5 lg:gap-10 px-10 py-10 rounded-3xl items-center justify-center ">
        <div className="flex flex-col items-center lg:items-start gap-5">
          ...
          <p className="text-center lg:text-start">Cayo de Perlas, RAACS, Nicaragua</p>
        </div>
        <div className="flex flex-col items-center lg:items-start gap-5">
          <p className="text-xl font-medium">Company</p>
          <p className="text-base">Lugares</p>
          <p className="text-base">Colaboradores</p>
          <p className="text-base">Spporte</p>
          <p className="text-base">Contactos</p>
        </div>
        <div className="flex flex-col items-center lg:items-start gap-5">
          <p className="text-xl font-medium">Ubicacion</p>
          <p className="text-base">Eventos</p>
          <p className="text-base">Reservaciones  </p>

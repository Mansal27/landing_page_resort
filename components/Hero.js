  ...
  return (
    <div className="DivConFondo">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8 "aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only bg-[#1e3a8a]">SUBETE! LATAM</span>
          ...
          <div className="hidden lg:flex lg:gap-x-12 text[#1e3a8a]" style={{ marginTop: '40px'}}>
            {navigation.map((item) => (
        ...
        <Dialog as="div" className="lg:hidden" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
          ...
          <Dialog.Panel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              <a href="#" className="-m-1.5 p-1.5">
                <span className="sr-only">SUBETE! LATAM</span>
                <img
                  className="h-13 w-auto"
                  src="/assets/Logo.png" alt="logo" width="200" height="200"
                />
              </a>
              <button
                type="button"
            ...
            <div className="mt-6 flow-root">
              <div className="-my-6 divide-y divide-gray-500/10">
                <div className="space-y-2 py-6 text[#1e3a8a]"  style={{ marginTop: '10px'}}>
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#0284c7] to-[#1e3a8a] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            ...
            Usa nuestro servicio moderno para viajar comodo, seguro y de manera sostenible.{' '}
          ...
          <div className="text-center">
           ...
           {/*  <p className="mt-6 text-justify text-m leading-8 text-white  rounded-full ring-2 ring-gray-900/10 hover:ring-gray-900/20">
              SUBETE! LATAM es un servicio de transporte de CAR SHARING. Para compartir carros particulares y reducir los autos en particulares en movimiento.  
            </p> */}
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <a
                href="#"
                className="rounded-md bg-[#1e3a8a] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#1e3a8a]"
              >Conocenos
              </a>
              {/* <a href="#" className="text-sm font-semibold leading-6 text-white">
                Nuestros conductores <span aria-hidden="true">→</span>
              </a> */}
            </div>
          </div>
        </div>
        ...
        >
          <div
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#0284c7] to-[#1e3a8a] opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
                'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
            }}
